                        ...
                        @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 justify-end">
                                ...
                                @else
                                    ...
                                    @endif
                                @endauth 
                                        <a href="{{ asset('Commission-BigC-Manual.pdf') }}" target="_blink" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                        >
                                            README
                                        </a>
                            </nav>
